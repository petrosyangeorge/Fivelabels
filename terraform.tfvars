#=========================For_ALL========================
product-name   = "fl"
google-project = "terraform-gcp-362210"
google-region  = "us-central1"
google-zone    = "us-central1-a"

#=====================CS_Back_Upload=====================
cs_back_upload-project_id  = "terraform-gcp-362210"
cs_back_upload-location    = "us-central1"
cs_back_upload-iam_members = { "role" : "roles/storage.objectViewer", "member" : "allUsers" }

#=====================CS_Front_Static====================
cs-front-static-project_id       = "terraform-gcp-362210"
...
csql-db-pg-authorized_networks = { "name" : "posgr", "value" : "37.252.95.250/32" }
